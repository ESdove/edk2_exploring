...
//总体思路是先分类,分完类之后define对应的宏留待后用
/**
 1.PCI_CLASS_MASS_STORAGE
 2.PCI_CLASS_NETWORK
 3.PCI_CLASS_MEDIA
 4.PCI_CLASS_BRIDGE
 5.PCI_CLASS_SYSTEM_PERIPHERAL
 6.PCI_CLASS_PROCESSOR
 7.PCI_CLASS_SERIAL
 8.PCI_CLASS_SATELLITE
 9.PCI_CLASS_PROCESSING_ACCELERATOR
