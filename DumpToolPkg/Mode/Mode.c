...
EFI_STATUS LocateSimpleTextInputEx()
{
  EFI_STATUS              Status;
  EFI_HANDLE              *Handles;
  UINTN                   HandleCount;
...
EFI_STATUS ShowSpecifyTextModeInfo(UINTN ModeNumber)
{
	EFI_STATUS    Status;
	UINTN         Columns;
	UINTN         Rows;
...
EFI_STATUS ShowSpecifyGraphicModeInfo(UINT32 ModeNumber)
{
	EFI_STATUS                             Status;
...
EFI_STATUS
EFIAPI
Mode(IN EFI_HANDLE ImageHandle,
